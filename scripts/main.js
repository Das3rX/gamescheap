...
function iconesSpanPanier() {
    ...
    for (let i = 0; i < titreArray.length; i++) {
        if (sessionStorage.getItem(titreArray[i]) != null) {
            let titre = JSON.parse(sessionStorage.getItem(titreArray[i]))[0];
            let icone = document.getElementById(titre);
        ...
        for (let i = 0; i < wishlistTitreArray.length; i++) {
            if (sessionStorage.getItem(wishlistTitreArray[i]) != null) {
                console.log(wishlistTitreArray[i])
                let titre = JSON.parse(sessionStorage.getItem(wishlistTitreArray[i]))[0];
                let icone = document.getElementById("w-" + titre);
                console.log("hmm " + icone)
                let span = icone.querySelector("span");
...
function adptationsPC() {
    ...
    if (window.innerWidth > 991) {
        imgPromotions.src = "img/Adaptations Grand Ecran/promotions.png";
        imgCodePromo.src = "img/Adaptations Grand Ecran/Codepromo.png";
        vendeurFiables.src= "img/Adaptations Grand Ecran/vendeursFiables.png"
        echoesOfTheEye.src= "img/Adaptations Grand Ecran/eote.png"
        portal2.src= "img/Adaptations Grand Ecran/portal2.png"
        dishonored2.src= "img/Adaptations Grand Ecran/dishonored2.png"
        bg3.src= "img/Adaptations Grand Ecran/bg3.png"
    }
}
